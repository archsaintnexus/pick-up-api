export function welcomeTemplate(email: string,fullName:string): string {
    return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
        ...
        <table width="520" cellpadding="0" cellspacing="0" style="background:#1a1a1a;border:1px solid #2a2a2a;border-radius:4px;overflow:hidden;">
          ...
          <tr>
            <td style="background:#111;padding:32px 40px;border-bottom:1px solid #222;">
              <p style="margin:0;color:#555;font-size:11px;letter-spacing:4px;text-transform:uppercase;">Account Verified</p>
              <h1 style="margin:8px 0 0;color:#fff;font-size:22px;font-weight:400;letter-spacing:2px;">Welcome Aboard,${fullName.toUpperCase()}</h1>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:32px;">
                <tr>
                  <td align="center" style="background:#0f0f0f;border:1px solid #333;border-radius:4px;padding:24px;">
                    ...
                    <p style="margin:0;color:#4ade80;font-size:16px;font-weight:700;letter-spacing:4px;text-transform:uppercase;">&#10003; Verified</p>
                  </td>
                </tr>
              </table>

              <p style="margin:0 0 16px;color:#888;font-size:14px;line-height:1.8;letter-spacing:0.5px;">
                Your email <span style="color:#fff;">${email}</span> has been successfully verified. Your account is now active and ready to use.
              </p>

              <p style="margin:0 0 32px;color:#888;font-size:14px;line-height:1.8;letter-spacing:0.5px;">
                You now have full access to all features. We're glad to have you with us.
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center">
                    <a href="${process.env.CLIENT_URL}" style="display:inline-block;background:#fff;color:#0f0f0f;text-decoration:none;font-size:12px;font-weight:700;letter-spacing:3px;text-transform:uppercase;padding:16px 40px;border-radius:2px;">
                      Get Started
                    </a>
                  </td>
                </tr>
