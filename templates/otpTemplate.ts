        ...
        <table width="520" cellpadding="0" cellspacing="0" style="background:#1a1a1a;border:1px solid #2a2a2a;border-radius:4px;overflow:hidden;">
          ...
          <tr>
            <td style="background:#111;padding:32px 40px;border-bottom:1px solid #222;">
              <p style="margin:0;color:#555;font-size:11px;letter-spacing:4px;text-transform:uppercase;">Verification Required</p>
              <h1 style="margin:8px 0 0;color:#fff;font-size:22px;font-weight:400;letter-spacing:2px;">One-Time Password</h1>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:40px;">
              <p style="margin:0 0 32px;color:#888;font-size:14px;line-height:1.8;letter-spacing:0.5px;">
                Use the code below to verify your account. This code is valid for <span style="color:#fff;">5 minutes</span> and can only be used once.
              </p>

              <!-- OTP Box -->
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center" style="background:#0f0f0f;border:1px solid #333;border-radius:4px;padding:28px;">
                    <p style="margin:0 0 8px;color:#555;font-size:10px;letter-spacing:4px;text-transform:uppercase;">Your Code</p>
                    <p style="margin:0;color:#fff;font-size:42px;font-weight:700;letter-spacing:12px;">${otp}</p>
                  </td>
                </tr>
              </table>
